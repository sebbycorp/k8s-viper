...
| **kagent UI** | `http://172.16.10.135:30500/` | OSS kagent 0.10.0-rc2 + Agent Substrate. Live chat targets today: `hello-substrate`, `fortigate`. `arista-ceos` is **not** a live chat target yet — pending Containerlab + Vault `secret/platform/arista-ceos` + `arista-ceos-mcp:dev` import — [kagent-substrate.md](kagent-substrate.md), [fortigate-agent.md](fortigate-agent.md), [arista-ceos-agent.md](arista-ceos-agent.md) |
